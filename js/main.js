// User code here
  ...
  $(function() {
    ...
    //Retrieve list of films, sort by release date, add them to drop down list
    ...
    $('.dropdown-menu').on('click',"li",function(e) {
      ...
      //Retrieves information on choosen film
      ...
      //Hides the table and shows a loading gif
      $('table').hide()
      $('#load-screen').show()
      ...
      filmRequest.done(function(filmData){
        ...
        selectedFilmRequest.done(function(){
          ...
          //When the call is finished, the starship name is mapped to the correct character in the selectedFilm
          //array. I wanted to do this more simply in the previous step, but running two loops and pushing the
          //result to a specific area in the array didn't cooperate well with the ajax call.
